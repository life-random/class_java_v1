...
// http://jsonplaceholder.typicode.com <-- 서버 주소
//                                     /todos/1 <-- 엔드 포인트
// 요청 완성 주소 : http://jsonplaceholder.typicode.com/todos/1
public class SimpleHttpClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 방어적 코드 작성
            if (responseCode != 200) {
                // 실패 응답의 본무의 getInputStream() 이 아니라
            ...
            // 5단게 : 응답 본문(HTTP 응답 메시지 바디 부분) 읽기
            ...
            // 6단계 : 연결 종료
            // HttpURLConnection : 예전에 만든 녀석이라 try-with-resoutces를 사용할 수 없음.
            // 문법적으로 인터페이스 Closeable을 구현하지 않아서 사용할 수 없음
            if (connection != null) {
                connection.disconnect(); // 연결 끓기
            }
        }
    }
}
